...
export default function MiniDrawer({ user, isUserLoggedIn, updateState }) {
        ...
        <Container style={{ maxWidth: '1100px' }}>
          <Switch>
            ...
            <Route
              ...
              component={CreateWokTemplate}
            />
            <Route
              exact
              path="/classwork/update"
              component={CreateWokTemplate}
            />
