    ...
    <div className='main-page-message'>
      <article className="page-message">
        <div className="page-message-header">
          <h4><i>Assign work to your class here</i></h4>
        </div>
        <div className="page-message-body">
          <p>
            <i className="fas fa-tasks"></i> <span>Create Assignments and questions</span>
          </p>
          {/* <p>
          <i className="fas fa-book"></i> <span> Upload materials to your work list</span>
          </p> */}
          <p>
